...
For examples of the production quality expectations for your game board, pieces, and rule book, please review this [folder](https://scrippscollege.box.com/s/mqptjj5wd43q9p7r4nbtrkkcbs9uege6) of student examples. These games are not all racing games; however, they represent the design and production value expectations for this project and the course.
...
Submit a PDF to this [link](https://scrippscollege.app.box.com/f/b1fbaf9e9c9443c6801be4044b488e42) with the following:
In 500-700 words, discuss the differences between Candy Land and Heat: Pedal to the Metal. Your
...
Once you have a solid concept in mind, create a project proposal for your racing game that answers each of the following questions. Use this [link](https://scrippscollege.app.box.com/f/729bb729a02742f5a4b1a656888691cd) to submit a pdf of your project proposal. Please include your first and last name in the file. Bring a printed copy of your proposal to class.
...
5.	What objects are being used in your game
    **a.**	What production processes do you plan to create the objects within your game?
    **b.**	Note: If you plan to use the laser cutter at Scripps, please see the section below on laser cutter files to get a better understanding of what can be produced with our current materials.
    **c.**	If you plan on using dice in your game, please indicate the type and number of dice you will be using. (e.g. two six-sided dice)
...
An Adobe Illustrator file must be submitted using this [link](https://scrippscollege.app.box.com/f/de35a8a87c5d44a48e8427762e96c268) the class before our laser cutting session. Your file name should include your first name and last name.
...
1.	A printed rule book.
    **a.**	Submit a pdf version of rule book to this [link](https://scrippscollege.app.box.com/f/5417e9960fed4204a985daf8eba4077e) if applicable.
